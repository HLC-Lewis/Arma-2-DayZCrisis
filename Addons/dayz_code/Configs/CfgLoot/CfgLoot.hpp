class CfgLoot {
	...
	civilian[] = {
			...
			{"5Rnd_556x45_Stanag",0.02},
			{"30Rnd_545x39_AKSD",0.02},
			{"kpfs_8Rnd_765x17",0.02}
	};
	...
	military[] = {
			...
			{"30Rnd_762x39_SA58",0.04},
			{"200Rnd_762x54_PKT",0.01},
			...
			{"RH_20Rnd_32cal_vz61",0.03},
			{"RH_6Rnd_44_Mag",0.03},
			{"FHQ_rem_5Rnd_338Lapua_MSR_T",0.01},
			{"FHQ_rem_5Rnd_300Win_XM2010_T",0.01},
			{"FHQ_rem_10Rnd_338Lapua_MSR_T",0.01},
			{"FHQ_rem_5Rnd_300Win_XM2010_T",0.01},
			{"VIL_30Rnd_556x45_HK",0.02},
			{"VIL_35Rnd_556x45_G",0.02},
			{"5Rnd_127x108_KSVK",0.01},
			{"FHQ_rem_20Rnd_762x51_PMAG_T",0.02},
			{"FHQ_rem_20Rnd_762x51_PMAG_T_SD",0.02},
			{"5Rnd_86x70_L115A1",0.01},
			{"200Rnd_556x45_L110A1",0.02},
	...
	policeman[] = {
			{"ItemBandage",0.99},
			{"15Rnd_W1866_Slug",0.30},
			{"8Rnd_B_Beneli_74Slug",0.50},
			{"HandRoadFlare",0.01},
			{"RH_6Rnd_44_Mag",0.20}
	};
	...
	hunter[] = {
			...
			{"5x_22_LR_17_HMR",0.06},
			{"10x_303",0.03},
			{"ItemWaterbottleUnfilled",0.10},
			{"FoodMRE",0.09}
		};
};